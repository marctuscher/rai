...
Edit finger1{ joint:transX Q:<> A:<t(+.07 0 -.05)> limits: [-.06 0.0], contact: -2, shape:box, size:[.02 .02 .05], drive:[100000. 50.], friction:1, mass:0.1, articulated:0}
Edit finger2{ joint:transX mimic:(finger1) Q:<> A:<d(180 0 0 1) t(+.07 0 -.05)>, limits: [-.06 0.0], contact: -2, shape:box, size:[.02 .02 .05], friction:1, mass:0.1 drive:[100000. 50.], mass: 0.1, articulated:0}
